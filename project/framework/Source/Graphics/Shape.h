...
public:
	...
	*/
	void AddBoneNodeToArray(BoneNode& rootnode, vector<Matrix>& jointMatrices, Matrix parentBindTransform);
	
	/**
	add Bone Node To Array for debug
	*/
	void AddBoneToArray(BoneNode& rootnode, vector<Matrix>& jointMatrices, Matrix parentBindTransform);//remove for game
private:
	int mJointCount;
